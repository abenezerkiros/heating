import heroImage from './assets/image/heaterHero.webp';
...
export const SITE = {
  ...
  hero: {
    title: "Providing Professional Heating Services",
    subtitle: "We are Your Local Heating Experts.", // Optional call to action text
